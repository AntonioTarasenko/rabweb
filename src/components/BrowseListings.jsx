...
const listings = [
  { id: 1, title: 'Clinic.com', category: 'Clinic', price: '$5', img: project1 },
  { id: 2, title: 'Dental.com', category: 'Clinic', price: '$6', img: project2 },
  {
    id: 3,
    title: 'Shop.com',
    category: 'E-commerce',
  ...
  { id: 7, title: 'Dashboard.com', category: 'E', price: '$11', img: project7 },
  {
    id: 8,
    title: 'Portfolio.com',
    category: 'Portfolio',
    ...
    <section className='px-4 md:px-12 py-14 mt-20 overflow-hidden font-[Montserrat]'>
      <div className='relative text-center mb-10' data-aos='fade-up'>
        ...
        <img
         src={rob} 
         alt='Left Emoji'
         className='absolute -left-4 md:left-24 top-6 md:top-1/2 -translate-y-1/2 w-20 h-20 -rotate-12' 
        />
        <img
         src={rob2} 
         alt='Right Emoji'
         className='absolute -right-4 md:right-24 top-6 md:top-1/2 -translate-y-1/2 w-24 h-24 rotate-12' 
        />

        <p className='text-gray-400 text-sm mt-4'>
          Find website, blogs, and online businesses ready to buy.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {filteredListings.map((site, index) => (
          ...
          >
            <img src={site.img} alt={site.title} className="w-full h-40 object-cover" />
            <div className="p-4">
              ...
              <button 
              className='mt-4 w-full bg-purple-600 hover:bg-purple-700 text-white py-2 rounded-md text-sm'>
                View Details
              </button>
            </div>
          </div>
